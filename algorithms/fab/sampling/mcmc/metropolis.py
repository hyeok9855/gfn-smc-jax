...
def build_metropolis(
    ...
    def step(
        ...
        def one_step(point: Point, key: chex.PRNGKey) -> Tuple[Point, float]:
            ...
            new_x = (
                point.x
                + jax.random.normal(key1, shape=point.x.shape) * transition_operator_state.step_size
            )
...
#             point = jax.tree_utils.tree_map(lambda a, b: broadcasted_where(accept, a, b), new_point, point)
